...
function Profile() {
    ...
    const changeAvatar = async(e) => {
        ...
        try {
            ...
            if(file.type !== 'image/jpeg' && file.type !== 'image/png') 
                return setData({...data, err: "Invalid file format.", success: ''})
    ...
    const updatePassword = () => {
        ...
        if(isLength(password))
            return setData({...data, err: "Password should be at least 6 characters long.", success: ''})
        ...
        <div className="profile_page">
            <div className="col-left">
                ...
                <div className="form-group">
                    ...
                    placeholder="Your name" defaultValue={user.name} onChange={handleChange} />
                </div>

                <div className="form-group">
                    <label htmlFor="email">Email</label>
                    <input type="email" name="email" id="email" 
                    placeholder="Your email address" defaultValue={user.email} disabled />
                </div>
